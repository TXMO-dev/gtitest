...
const NavbarNavigationComponent = ({title,to,disabled}) => {
    return (
        <>
        {
            
            disabled === true && (
                <NavLink style={{pointerEvents:'none'}} to={to} className={({isActive}) => !isActive ? "h-[70px] py-[23px] px-[29px] flex items-center justify-items-center hover:bg-gradient-to-b from-[#FFFFFF] via-transparent to-[#F5D410]" : "h-[70px] py-[23px] px-[29px] flex items-center justify-items-center bg-gradient-to-b from-[#FFFFFF] via-transparent to-[#F5D410]"}>
