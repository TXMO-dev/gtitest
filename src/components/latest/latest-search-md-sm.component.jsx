const LatestSearchMdSMComponent = () => {
    return (
        <>
            <div className="lg:hidden md:hidden flex mb-[60px] flex-col w-full h-full bg-[#FFFFFF] pt-[27.92px] pb-[20.22px] pl-[20px] pr-[20px]">
            <span className="relative w-full mb-[25px]">
                <input className="placeholder:text-[#575960] outline-none placeholder:font-[275] placeholder:text-[16px] placeholder:leading-[41.49px] flex items-center border-[2px] border-[#0062E1] rounded-full w-full pl-[35px] pr-[22.86px] pt-[16.58px] pb-[15.28px]" placeholder="lorem ipsum"/>
                ...
                <select className="flex border-[2px] outline-none mb-[25px] border-[#0062E1] rounded-full w-full pl-[35px] pr-[22.86px] py-[15.68px]">
                ...
                <span className="relative w-full mb-[25px]">
                <input className="placeholder:text-[#575960] outline-none placeholder:font-[275] placeholder:text-[16px] placeholder:leading-[41.49px] flex items-center border-[2px] border-[#0062E1] rounded-full w-full pl-[35px] pr-[22.86px] pt-[16.58px] pb-[15.28px]" placeholder="05 Mai,2021"/>
                    <span className="absolute bg-[#FFFFFF] text-[#0062E1] -top-6 left-[30px] font-[600] text-[13.83px] leading-[41.49px]">
                        when
                    </span>
                </span>
                <div className="rounded-full bg-[#F5D410] w-full h-[52px] py-[16px] px-[12px] flex items-center justify-items-center place-content-center">
...
export default LatestSearchMdSMComponent;